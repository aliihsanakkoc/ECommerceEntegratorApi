...
public class UpdateClothingCommand : IRequest<UpdatedClothingResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class UpdateClothingCommandHandler : IRequestHandler<UpdateClothingCommand, UpdatedClothingResponse>
    {
        ...
        public UpdateClothingCommandHandler(IMapper mapper, IClothingRepository clothingRepository,
