...
public static class CategoriesBusinessMessages
{
    ...
    public const string FullCategoryNameIsAlreadyExist = "FullCategoryNameIsAlreadyExist";
    public const string CategoryIsTopCategory = "Category Is TopCategory DO NOT DELETE!";
}