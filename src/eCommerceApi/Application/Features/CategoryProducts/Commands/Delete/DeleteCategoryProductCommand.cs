...
public class DeleteCategoryProductCommand
    : IRequest<DeletedCategoryProductResponse>,
        ISecuredRequest,
        ...
        ITransactionalRequest
{
    ...
    public class DeleteCategoryProductCommandHandler
        : IRequestHandler<DeleteCategoryProductCommand, DeletedCategoryProductResponse>
    {
        private readonly IMapper _mapper;
        private readonly ICategoryProductRepository _categoryProductRepository;
        private readonly CategoryProductBusinessRules _categoryProductBusinessRules;

        public DeleteCategoryProductCommandHandler(
            IMapper mapper,
        ...
        public async Task<DeletedCategoryProductResponse> Handle(
