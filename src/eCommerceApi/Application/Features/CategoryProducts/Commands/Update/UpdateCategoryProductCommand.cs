...
public class UpdateCategoryProductCommand
    : IRequest<UpdatedCategoryProductResponse>,
        ISecuredRequest,
        ...
        ITransactionalRequest
{
    ...
    public class UpdateCategoryProductCommandHandler
        : IRequestHandler<UpdateCategoryProductCommand, UpdatedCategoryProductResponse>
    {
        private readonly IMapper _mapper;
        private readonly ICategoryProductRepository _categoryProductRepository;
        private readonly CategoryProductBusinessRules _categoryProductBusinessRules;

        public UpdateCategoryProductCommandHandler(
            IMapper mapper,
