...
public class CreateCategoryProductCommand : IRequest<CreatedCategoryProductResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
    ...
    public class CreateCategoryProductCommandHandler : IRequestHandler<CreateCategoryProductCommand, CreatedCategoryProductResponse>
    {
        private readonly IMapper _mapper;
        private readonly ICategoryProductRepository _categoryProductRepository;
        private readonly CategoryProductBusinessRules _categoryProductBusinessRules;

        public CreateCategoryProductCommandHandler(IMapper mapper, ICategoryProductRepository categoryProductRepository,
        ...
        public async Task<CreatedCategoryProductResponse> Handle(CreateCategoryProductCommand request, CancellationToken cancellationToken)
        {
